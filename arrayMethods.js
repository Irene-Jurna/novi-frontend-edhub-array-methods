...
// let inventorsSixteenthCentury = [];
//
// for (let i = 0; i < inventors.length; i++) {
//   if (inventors[i].year >= 1500 && inventors[i].year < 1600) {
//     inventorsSixteenthCentury.push(inventors[i].year);
//   }
// }
//
// console.log(inventorsSixteenthCentury);

// Methode: filter-methode
...
//Metode: filter korter

const sixteenCentury = inventors.filter((inventor) => inventor.year >= 1500 && inventor.year < 1600);
...
const dateOfBirth = inventors.map((inventor) => {
...
const birthYear = inventors.map((inventor) => inventor.year);
...
const edisonDetails = inventors.find((edisonDetail) => {
    return edisonDetail.last === 'Edison';
});
...
const getEdison = inventors.find((edison) => edison.last === 'Edison');
console.log(getEdison);